      ...
      <div className="portal-hero-content relative z-10 mx-auto w-full max-w-[1400px] px-5 text-center lg:px-8">
        <div className="shrink-0">
          <div className="portal-hero-heading flex items-center justify-center gap-3 sm:gap-4">
            <span className="gapyeong-symbol" aria-hidden="true"><img src={gapyeongLogo} alt="" /></span>
            <h1 className="break-keep text-[1.75rem] font-extrabold leading-tight tracking-tight text-text-primary sm:text-3xl md:text-[2.5rem]">가평군청 계약정보를 한눈에 확인하세요</h1>
          </div>
