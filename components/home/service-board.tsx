...
import { G2B_URL } from "@/components/procurement/procurement-page-config"
...
const services: ServiceItem[] = [
  {
    ...
    links: [
      { label: "발주계획", href: G2B_URL, external: true, showExternalIcon: false },
      { label: "입찰공고", href: G2B_URL, external: true, showExternalIcon: false },
      { label: "개찰결과", href: G2B_URL, external: true, showExternalIcon: false },
    ],
  ...
  {
    title: "계약현황",
    description: "가평군이 체결한 공사·용역·물품·수의계약 내역을 유형별로 확인하세요.",
    links: ["공사", "용역", "물품", "수의계약"],
  ...
  },
  {
    ...
    links: [
      { label: "계약법규", href: "/information/laws" },
      { label: "계약서식", href: "/information/forms" },
    ],
    href: "/information/laws",
    icon: LibraryBig,
    tone: "teal",
  },
]
...
export function ServiceBoard() {
  return (
    <section id="services" aria-labelledby="services-title" className="bg-section pb-12 pt-4 md:pb-20 md:pt-5">
