...
export const contracts = [
  ...
  { type: "공사", date: "2026.03.13", title: "성남중앙공원 산책로 및 편의시설 정비공사", partner: "(주)성남건설", amount: "128,400,000원" },
  { type: "용역", date: "2026.03.12", title: "2026년 성남시 공공데이터 품질관리 및 개방 지원 용역", partner: "디지털파트너스", amount: "96,800,000원" },
]
